...
export function ImagePreview({ images, onRemove }: ImagePreviewProps) {
  ...
  return (
    <div className="flex gap-2 px-4 py-2 border-t border-stone-200 overflow-x-auto" data-testid="image-preview-container">
      {images.map((image) => (
        <div key={image.id} className="relative flex-shrink-0" data-testid="image-preview-item">
          <div
